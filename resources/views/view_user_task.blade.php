...
<div class="position-relative mx-n4 mt-n4">
    <div class="profile-wid-bg profile-setting-img">
        <img src="{{asset('/images/profile-bg.jpg')}}" class="profile-wid-img" alt="">
    </div>
</div>
            ...
            <div class="card-body p-4">
                <div class="text-center">
                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                        <img src="{{asset('/images/users/avatar-1.jpg')}}" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
...
<div class="card-body p-4">
    <div class="tab-content">
        <div class="tab-pane active" id="personalDetails" role="tabpanel">
            <form action="/edit/user/{{$user->id}}/task/{{$task->id}}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="firstnameInput" class="form-label">Task Title</label>
                            <input type="text" name="title" class="form-control" id="firstnameInput" placeholder="Enter your task title" value="{{$task->title}}">
                        </div>
                    </div>
                    <!--end col-->
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="lastnameInput" class="form-label">Task Due Date</label>
                            <input type="text" name="due_date" class="form-control" id="lastnameInput" placeholder="Enter task due date" value="{{$task->due_date}}">
                        </div>
                    </div>
                    <!--end col-->
                    <div class="col-lg-12">
                        <div class="mb-3 pb-2">
                            ...
                            <textarea class="form-control" name="description" id="exampleFormControlTextarea" placeholder="Enter your description" rows="3">{{$task->description}}
                            </textarea>
                            </div>
                    </div>
                    <!--end col-->
